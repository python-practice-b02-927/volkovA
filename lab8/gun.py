...
class gun():
    ...
    def fire2_end(self, event):
        ...
        global balls, bullet
        bullet += 1
        new_ball = ball(20, 450, 5, self.f2_power * math.cos(self.an), - self.f2_power * math.sin(self.an), 'yellow')
        # new_ball.r = 5
        # new_ball.x = 400
        # new_ball.y = 20
        # new_ball.color = 'yellow'
        # new_ball.vx = self.f2_power * math.cos(an)
        # new_ball.vy = - self.f2_power * math.sin(an)
        balls += [new_ball]
        self.f2_on = 0
        self.f2_power = 10
...
def new_game(event=''):
    global t1, screen1, balls, bullet, gun
    t1.new_target()
    bullet = 0
    balls = []
